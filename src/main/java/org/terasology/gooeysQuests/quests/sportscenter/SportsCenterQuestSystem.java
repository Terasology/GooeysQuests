 ...
 */
package org.terasology.gooeysQuests.quests.sportscenter;
...
public class SportsCenterQuestSystem extends BaseComponentSystem{
    ...
    public void onCreateStartQuestsEvent(CreateStartQuestsEvent event, EntityRef character,
        ...
        Prefab questPrefab = assetManager.getAsset("GooeysQuests:SportsCenterQuest", Prefab.class).get();
    ...
    @ReceiveEvent(components = SportsCenterQuestComponent.class)
    public void onPrepareQuest(PrepareQuestEvent event, EntityRef quest) {
        ...
        EntityRef entranceSpawner = structureTemplateProvider.getRandomTemplateOfType("GooeysQuests:SportCenter");
