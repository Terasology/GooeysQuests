 ...
 */
package org.terasology.gooeysQuests.quests.hellDungeon;
...
/**
 * Makes gooey offer a hell dungeon quest
 */
@RegisterSystem(RegisterMode.AUTHORITY)
public class HellDungeonQuestSystem extends BaseComponentSystem {
    ...
    public void onCreateStartQuestsEvent(CreateStartQuestsEvent event, EntityRef character,
        ...
        Prefab questPrefab = assetManager.getAsset("GooeysQuests:HellDungeonQuest", Prefab.class).get();
    ...
    @ReceiveEvent(components = HellDungeonQuestComponent.class)
    public void onPrepareQuest(PrepareQuestEvent event, EntityRef quest) {
        ...
        EntityRef etranceSpawner = structureTemplateProvider.
                getRandomTemplateOfType("GooeysQuests:hellDungeonEntrance");
